...
var rapidweaver_should_remember_cookie_setting=true;var rapidweaver_privacy_message_dismiss_button=document.getElementById('rapidweaver_privacy_message_dismiss_button');var rapidweaver_privacy_message_storage_name="has_shown_rapidweaver_privacy_message";rapidweaver_privacy_message_dismiss_button.onclick=function(){rapidweaver_hideMessage();rapidweaver_setCookieSetting(rapidweaver_privacy_message_storage_name,"false");};function rapidweaver_hideMessage(){var message=document.getElementById('rapidweaver_privacy_message');message.parentNode.removeChild(message);}
